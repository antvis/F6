  ...
  return (function (t) {
    ...
    10(t, e, r) {
      ...
      const o =
        ...
        function (t, e) {
          for (const r in t)
            r === 'default' || Object.prototype.hasOwnProperty.call(e, r) || n(e, t, r);
        };
    ...
    14(t, e, r) {
      ...
      e.getDegree = function (t, e, r) {
        ...
        return r
          ? (r.forEach((t) => {
              t.source && (n[e[t.source]] += 1), t.target && (n[e[t.target]] += 1);
            }),
            n)
          : n;
      };
      e.floydWarshall = function (t) {
        ...
        for (let i = 0; i < r; i += 1)
          for (n = 0; n < r; n += 1)
            for (o = 0; o < r; o += 1) e[n][o] > e[n][i] + e[i][o] && (e[n][o] = e[n][i] + e[i][o]);
        return e;
      };
      ...
      e.traverseTreeUp = function (t, e) {
        typeof e === 'function' &&
          (function t(e, r) {
            if (e && e.children)
              for (let n = e.children.length - 1; n >= 0; n--) if (!t(e.children[n], r)) return;
            return !!r(e);
          })(t, e);
      };
    },
        ...
        return (
          ...
          (e.prototype.execute = function () {
            ...
            if (r !== 0) {
              ...
              if (r === 1)
                return (
                  (t[0].x = n[0]), (t[0].y = n[1]), void (this.onLayoutEnd && this.onLayoutEnd())
                );
              let o = this.radius;
              let i = this.startRadius;
              let s = this.endRadius;
              const c = this.divisions;
              const a = this.startAngle;
              const f = this.endAngle;
              const d = (f - a) / r;
              const l = {};
              t.forEach((t, e) => {
                l[t.id] = e;
                ...
                (this.nodeMap = l);
              const h = u.getDegree(t.length, l, e);
              (this.degrees = h),
                o || i || s
                  ? !i && s
                    ? (i = s)
                    : i && !s && (s = i)
                  : (o = this.height > this.width ? this.width / 2 : this.height / 2);
              const p = d * this.angleRatio;
              const y = this.ordering;
              let g = [];
              g =
                y === 'topology'
                  ...
                  ? this.degreeOrdering()
                  : t;
              for (let v = this.clockwise, b = Math.ceil(r / c), _ = 0; _ < r; ++_) {
                let O = o;
                O || i === null || s === null || (O = i + (_ * (s - i)) / (r - 1)),
                  O || (O = 10 + (100 * _) / (r - 1));
                let j = a + (_ % b) * p + ((2 * Math.PI) / c) * Math.floor(_ / b);
                v || (j = f - (_ % b) * p - ((2 * Math.PI) / c) * Math.floor(_ / b)),
                  (g[_].x = n[0] + Math.cos(j) * O),
                  (g[_].y = n[1] + Math.sin(j) * O),
                  (g[_].weight = h[_]);
              }
              return this.onLayoutEnd && this.onLayoutEnd(), { nodes: g, edges: this.edges };
            }
            this.onLayoutEnd && this.onLayoutEnd();
          }),
          (e.prototype.topologyOrdering = function (t) {
            void 0 === t && (t = !1);
            const e = this.degrees;
            const r = this.edges;
            const n = this.nodes;
            const o = u.clone(n);
              ...
              o.forEach((t, u) => {
                if (u !== 0)
                  if (
                    ...
                    for (var l = s[d].children, h = !1, p = 0; p < l.length; p++) {
                      const y = i[l[p]];
                      if (e[y] === e[u] && !a[y]) {
                        s.push(o[y]), c.push(n[i[o[y].id]]), (a[y] = !0), (h = !0);
                        break;
                      }
                    }
                    for (
                      let g = 0;
                      !h &&
                      (a[g] || (s.push(o[g]), c.push(n[i[o[g].id]]), (a[g] = !0), (h = !0)),
                      ++g !== f);
