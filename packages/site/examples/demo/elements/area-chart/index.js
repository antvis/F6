...
F6.registerNode("area", {
  draw(cfg, group) {
    ...
    const strokeColors = ["rgba(91, 143, 249,1)", "rgba(90, 216, 166,1)", "rgba(246, 189, 22,1)", "rgba(232, 104, 74,1)", "rgba(255, 157, 77,1)"];
    const fillColors = ["rgba(91, 143, 249,0.5)", "rgba(90, 216, 166,0.5)", "rgba(246, 189, 22,0.5)", "rgba(232, 104, 74,0.5)", "rgba(255, 157, 77,0.5)"];
