...
QUnit.test(
  'When a tripleTap is fired, doubleTap and Tap should not be recognized',
  function (assert) {
...
QUnit.test(
  'When a doubleTap is fired, tripleTap and Tap should not be recognized',
  function (assert) {
    var done = assert.async();
    assert.expect(3);
...
QUnit.test(
  'When a tap is fired, tripleTap and doubleTap should not be recognized',
  function (assert) {
    var done = assert.async();
    assert.expect(3);
