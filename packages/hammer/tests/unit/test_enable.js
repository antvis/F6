...
QUnit.test(
  'should disable a recognizer through the `enable` constructor parameter',
  function (assert) {
    assert.expect(1);
...
QUnit.test(
  'should disable recognizing when the manager is disabled.',
  function (assert) {
    assert.expect(1);
...
QUnit.test(
  'should toggle a recognizer using the `set` call to the recognizer enable property',
  function (assert) {
    assert.expect(2);
...
QUnit.test(
  'should accept the `enable` constructor parameter as function',
  function (assert) {
    assert.expect(2);
...
QUnit.test(
  'should pass the recognizer and optional the input parameter to the `enable` callback',
  function (assert) {
    assert.expect(2);
