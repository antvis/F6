...
For React project integration, we have an independent product recommendation: [Graphin](https://graphin.antv.vision), which is a toolkit based on f6 and React, that focuses on relational visual analysis. It's simple, efficient, out of the box.
